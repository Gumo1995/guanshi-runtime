...
(function attachDomRefsModule(globalScope) {
  ...
  const ID_REF_PAIRS = [
    ...
    ["calendarEventScoreTrigger", "calendar-event-score-trigger"],
    ...
    ["overviewJudgment", "overview-judgment"],
    ["pomodoroFloatingPanel", "pomodoro-floating-panel"],
    ["pomodoroFloatingHandle", "pomodoro-floating-handle"],
    ["pomodoroFloatingCollapseBtn", "pomodoro-floating-collapse"],
    ["pomodoroFloatingSummary", "pomodoro-floating-summary"],
    ...
    ["pomodoroScoreTrigger", "pomodoro-score-trigger"],
    ...
    ["sidebarAiDockButton", "sidebar-ai-dock-button"],
    ["sidebarAiPanel", "sidebar-ai-panel"],
    ["sidebarAiCloseBtn", "sidebar-ai-close-btn"],
    ["sidebarAiForm", "sidebar-ai-form"],
    ["sidebarAiInput", "sidebar-ai-input"],
    ["sidebarAiStatus", "sidebar-ai-status"],
    ["todoSortMenu", "todo-sort-menu"],
    ["todoSortCurrent", "todo-sort-current"],
    ["todoFilterBar", "todo-filter-bar"],
    ["todoScopeMenu", "todo-scope-menu"],
    ["todoScopeCurrent", "todo-scope-current"],
    ["todoScopeAllBtn", "todo-scope-all"],
    ["todoLayout", "todo-layout"],
    ["todoDetailResizer", "todo-detail-resizer"],
    ...
    ["todoPriorityInput", "todo-priority-input"],
    ...
    ["syncGovernanceModal", "sync-governance-modal"],
    ["syncGovernanceNav", "sync-governance-nav"],
    ["syncGovernanceContent", "sync-governance-content"],
    ["syncGovernanceNormalCount", "sync-governance-normal-count"],
    ["syncGovernanceRemainingCount", "sync-governance-remaining-count"],
  ...
  const SELECTOR_REF_PAIRS = [
    ...
    ["sidebarAiActionButtons", "[data-ai-action]", "all"],
